...
export type MusicPlatformType = "netease" | "qq" | "kuwo" | "kugou";

export type PlaylistStorageMode = "online" | "local" | "my";

export type PlatformTrackIdType = string;
...
export type SongType = {
  ...
  /** 平台歌曲 ID */
  platformSongId?: PlatformTrackIdType;
  /** 平台专辑 ID */
  ...
  lyricsRaw?: string;
  /** 平台扩展数据 */
  thirdPartyMeta?: Record<string, any>;
  /**
   * 歌曲类型
  ...
  serverId?: string;
  /** 来源标记 */
  source?: "streaming" | MusicPlatformType;
  /** 标记 */
  mark?: number;
  /** ReplayGain 信息 */
...
export type CoverType = {
  ...
  updateTip?: string;
  platform?: MusicPlatformType;
  sourceType?: "toplist" | "playlist" | "my";
  thirdPartyId?: string;
  tracks?: {
    first: string;
    second: string;
