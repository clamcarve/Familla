...
const songMoreOptions = computed<DropdownOption[]>(() => {
  ...
  const isThirdParty = !!song.platform && song.platform !== "netease";
  return [
    {
      key: "more",
      label: "更多操作",
      ...
      children: [
        ...
        },
        {
          key: "copy-song-info",
          label: "复制更多信息",
          show: !isLocal && !isThirdParty && isSong,
          props: {
    ...
    },
    {
      ...
      props: {
        onClick: () =>
          openPlaylistAdd(
            [song],
            song.path ? "local" : song.platform && song.platform !== "netease" ? "my" : "online",
          ),
      },
    ...
    },
    {
      key: "download",
      label: "下载歌曲",
      show: statusStore.isDeveloperMode && !isLocal && !isThirdParty && isSong,
